...
export const whatsappService = {
  ...
  getLocalFallbackResponse(payload: WhatsAppMessagePayload): WhatsAppMessageResponse {
    ...
    if (text === '1' || text.includes('water') || text.includes('पानी') || text.includes('kolar') || text.includes('sangrur')) {
      return {
        success: true,
