        ...
        return [
          {
            ...
            description: 'Rapid localized drop >15 cm/day exceeding normal diurnal curve.',
            icon: 'TrendingDown',
            color: '#dc2626',
          },
          {
            ...
            description: 'Continuous multi-day drawdown with zero night-time hydrostatic recharge window.',
            icon: 'ShieldAlert',
            color: '#ea580c',
          },
          {
            ...
            description: 'Observation well has missed scheduled transmission interval.',
            icon: 'Radio',
            color: '#d97706',
          },
          {
            category: 'Sensor Issue' as const,
            name: 'Potential Sensor Error',
            count: sum.sensor_error_count,
            description: 'Reading flatlines, sudden step jumps, or low battery voltage ripple.',
            icon: 'Activity',
            color: '#ca8a04',
          },
          {
            ...
            description: 'Sharp water table rise from monsoon infiltration or riverbank seepage.',
            icon: 'Droplets',
            color: '#16a34a',
          },
        ];
