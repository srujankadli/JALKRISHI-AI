  ...
  getMockUserProfile(email: string, role: string = 'hydrogeologist'): UserProfile {
    const profiles: Record<string, UserProfile> = {
      'admin@jalkrishi.gov.in': {
        ...
        assigned_state: 'Pan-India National Network (5,260 DWLR Wells)',
        avatar_initials: 'RS',
      },
