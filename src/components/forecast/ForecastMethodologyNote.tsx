    ...
    <div className="rounded-2xl border border-stone-200 bg-stone-50/80 p-4.5 text-xs text-stone-700 space-y-2">
      ...
      >
        <div className="flex items-center gap-2 font-extrabold text-stone-900">
          ...
          <span>How JalKrishi AI Groundwater Forecasts Work (Methodology & Transparency)</span>
        </div>
      ...
      {isOpen && (
        <div className="mt-3 pt-3 border-t border-stone-200/70 space-y-2 text-[11px] text-stone-600 animate-fadeIn">
          <div>
            <strong className="text-stone-900">1. Drawdown Velocity Model: </strong>
            Calculates 30-day moving average depletion slope (m/month) based on telemetry hydrostatic head pressure records.
          </div>
          <div>
            <strong className="text-stone-900">2. Days-to-Critical Threshold: </strong>
            Estimated as (Current Depth - Critical Threshold) / Daily Depletion Rate, bounded by seasonal rainfall recharge coefficients.
          </div>
          <div>
            <strong className="text-stone-900">3. Uncertainty & Confidence Envelope: </strong>
