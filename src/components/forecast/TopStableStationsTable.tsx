...
export const TopStableStationsTable: React.FC<TopStableStationsTableProps> = ({
  ...
  return (
    <div className="space-y-4">
      <SectionHeader
        title={t('10 Lower-Risk & Stable Stations')}
        subtitle={t('Observation wells with robust storage buffer, positive infiltration, and safe multi-horizon margins')}
          ...
          <table className="w-full text-left text-xs sm:text-sm">
            <thead className="bg-stone-50 text-stone-600 uppercase text-[11px] font-bold border-b border-stone-200">
              <tr>
                ...
                <th className="px-4 py-3">{t('Safety Margin')}</th>
                ...
                >
                  ...
                  <td className="px-4 py-3 text-emerald-700 font-bold">
                    <span className="inline-flex items-center gap-1">
                      ...
                      {st.trend === 'rising' ? '+0.18 m/mo' : t('Stable')}
                    </span>
                  </td>
