    ...
    <div className="rounded-2xl border border-stone-200 bg-stone-50/80 p-4.5 text-xs text-stone-700 space-y-2">
      ...
      >
        <div className="flex items-center gap-2 font-extrabold text-stone-900">
          ...
          <span>{t('How Crop Recommendations Are Calculated (Hydro-Agronomic Model & Disclaimer)')}</span>
        </div>
      ...
      {isOpen && (
        <div className="mt-3 pt-3 border-t border-stone-200/70 space-y-2 text-[11px] text-stone-600 animate-fadeIn">
          <div>
            <strong className="text-stone-900">{t('1. Weighted Scoring Framework:')} </strong>
          ...
          <div>
            <strong className="text-stone-900">{t('2. Aquifer-Aware Weighting:')} </strong>
          ...
          <div>
            <strong className="text-stone-900">{t('3. Simulation Disclaimer:')} </strong>
