...
export const FarmerActionCenter: React.FC = () => {
  ...
  const actions = [
    ...
    },
    {
      ...
      description: 'Review historical monthly rainfall context and calculated infiltration characteristics in your district.',
      cta: 'View Rainfall Context',
      icon: CloudRain,
      iconBg: 'bg-sky-100',
      iconColor: 'text-sky-700',
      borderHover: 'hover:border-sky-300',
      badge: 'Infiltration Context',
