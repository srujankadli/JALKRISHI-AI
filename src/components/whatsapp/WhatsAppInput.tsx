  ...
  return (
    ...
    >
      ...
      <button
        ...
        disabled={disabled}
        title={t('Share GPS Location (Kolar 13.13N, 78.13E)')}
      ...
      <button
        type="button"
        disabled={disabled}
        title={t('Attach Document / Farm Photo')}
      ...
      <div className="flex-1 relative">
        <input
          ...
          disabled={disabled}
          placeholder={t('Type a message (e.g. \'Kolar water\', \'1\', \'फसल सलाह\')...')}
